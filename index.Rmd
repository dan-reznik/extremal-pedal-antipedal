...
Highly non-linear isocurves of area for the antipedal triangle with respect to points in the plane are shown below for three triangles (acute, right, and obtuse). Note the area of the antipedal is zero on the circumcircle, where it shrinkts to a point. Now, where is it extremal?
...
It turns out $T''$ minimizes area with respect to the Orthocenter $X_4$ of $T$, i.e., it is the anticomplementary triangle [@mw] and the minimal area is $4A$.

The antipedal's minimal pedal polygon will be its medial, i.e., $T$.
