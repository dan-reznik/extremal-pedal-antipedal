...
To see this, recall $X_4$ is the isogonal conjugate of $X_3$. Suppose another point $X'$ existed with respect to which the antipedal had lower area than $A^*$. This would be a contradiction, since $A'$ is maximal.

Given a triangle, the antipedal with respect to $X_4$ is its the anticomplementary triangle [@mw], so the minimal area is $4A$. As before, the antipedal's maximal-area pedal polygon will be its medial, i.e., the original $T$ itself.
