...
Below non-linear isocurves of area for the antipedal triangle with respect to points in the plane is shownm. From left to right: an acute, right, and obtuse triangles are shown. The minimal-area antipedal (anticomplementary triangle) is shown green, as is this triangle's $X_3'$ (reference $X_4$). Note zero-area iso-curves along the circumcircle, where the antipedal triangle shrinks to a point.
